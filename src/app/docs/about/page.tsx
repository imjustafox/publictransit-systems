      ...
      <Card elevated>
        ...
        <CardContent>
          <p className="text-text-secondary leading-relaxed mb-4">
            ...
            railcars, and historical information. Multi-mode systems are organized into networks, so
            commuter rail, light rail, and trams each get their own view within one system.
          </p>
